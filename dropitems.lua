    ...
    combatpdw_scope = `w_at_scope_medium`,
      ...
      clean_card = `p_ld_id_card_002`,
        ...
        weapon_glock19gen4 = `glock19gen4`,
          ...
          bandedcash = `prop_anim_cash_pile_01`,
          chocolate_donut = `prop_donut_02`,
          vanilla_donut = `prop_donut_01`,
          strawberry_donut = `prop_donut_01`,
          pizza_slice = `v_res_tt_pizzaplate`,
          hotdog = `prop_cs_hotdog_01`,
          energydrink = `prop_orang_can_01`,
