...
Config.MaxInventoryWeight = 200000 -- Max weight a player can carry (default 200kg, written in grams)
Config.MaxInventorySlots = 36 -- Max inventory slots for a player (6 hotbar + 30 main)
...
-- Vending Machine Items for qb-shops
Config.VendingCola = {
    [1] = {
        name = "kurkakola",
        price = 5,
